  ...
  const initialOrders: IOrder[] = [
    {
      ...
      statusHistory: [
        ...
        { status: 'Delivered', timestamp: new Date(Date.now() - 5 * 86400000 + 120 * 60000).toISOString(), note: 'Delivered by rider' },
      ],
    ...
    },
    {
      ...
      customerInfo: {
        ...
        email: 'david.m@example.com',
        deliveryAddress: 'Kharendrapur Main Road',
        city: 'Kapilvastu',
        area: 'Shivaraj-3',
        landmark: 'Beside Kharendrapur Chowk',
      },
      items: [
        {
          productId: 'prod-2',
